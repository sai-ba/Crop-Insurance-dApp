module crop_insurance::Insurance {
    ...
    fun init_module(account: &signer) {
        // No special initialization needed for this module
    }
    ...
    public entry fun claim_policy(account: &signer) acquires Policy {
        let owner = signer::address_of(account);
    ...
    // View functions
    public fun get_farmer_info(farmer_addr: address): (String, String, u64) acquires Farmer {
    ...
    public fun get_policy_info(owner: address): (u64, u64, u64, bool) acquires Policy {
        assert!(exists<Policy>(owner), EPOLICY_NOT_FOUND);
